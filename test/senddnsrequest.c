...
int main(int argc , char *argv[]){
	...
	setsockopt(socketfd, IPPROTO_TCP, TCP_NODELAY, (const void *)&flag, sizeof(int));
...
static void send_dns_request(const char *dns_name){
	...
	//sendto(socketfd , request , 256 , 0, (struct sockaddr*)&dest , sizeof(struct sockaddr));
