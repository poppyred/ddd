...
<div class="content"><!-- 内容 -->
	...
	<div id="sideMenu" class="side">
		...
		<div class="bd">
			<ul>
				<li><a style="color:#3CADED; text-decoration:underline;" href="__APP__/Runmgr/route">用户自定义路线列表</a></li>
	...
	<div class="mainContent">
		...
		<div class="slideTxtBox">
			<div class="hd">
				<h2 style="float:left;">用户自定义路线列表</h2>
			</div>
			<div class="bd">
				<ul>
						...
						<tbody id="myData">
							<?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s_vo): $mod = ($i % 2 );++$i;?><tr class="data"> 	 	
								...
								<td class="val" style="text-align:left;">
									<a title="" href="__APP__/System/editView?id=<?php echo ($s_vo["id"]); ?>"><?php echo ($s_vo["name"]); ?></a>
								</td>
								<td class="iop"><?php echo ($s_vo["zone_id"]); ?></td>
								<td class="iop"><?php echo ($s_vo["timespan"]); ?></td> 
								<td class="iop">
									<a title="查看详情" href="javascript:void(0);" onclick="deleteDns(<?php echo ($s_vo["id"]); ?>,this)">详情</a>
