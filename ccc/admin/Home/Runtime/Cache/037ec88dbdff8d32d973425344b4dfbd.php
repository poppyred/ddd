...
<div class="content"><!-- 内容 -->
	...
	<div id="sideMenu" class="side">
		...
		<div class="bd">
			<ul>
				...
				<li><a style="color:#3CADED; text-decoration:underline;" href="__APP__/Runmgr/addns">添加默认NS记录</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="mainContent">
		...
		<div class="slideTxtBox">
			<div class="hd">
				<h2 style="float:left;">添加默认NS记录</h2>
			</div>
			<div class="bd">
				<ul>
					<table class="ui-table" cellpadding="0" cellspacing="0" width="100%" id="mytab" style="margin-left:20px;">	
						<tbody id="myData">
							<tr class="data">
							    ...
							    <td class="edit"><input class="ui-ipt-txt" type="text" id="txt_val" placeholder="记录值"> *</td>
							    <td class="info">例如：ns0.eflydns.com</td>
							</tr>
							<tr class="data">
							    <td class="laber">视图</td>
							    <td class="edit"><select id="txt_view">
										    <?php if(is_array($vlist)): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									    </select>*
							    </td>
							    <td class="info"></td>
							</tr>
							<tr class="data">
							    ...
							    <td class="edit"><select id="txt_level">
							...
							<tr class="data">
							    ...
							    <td class="edit"><input class="ui-ipt-txt" type="text" id="txt_ttl" placeholder="TTL"> *</td>
							    <td class="info">单位：分钟</td>
							</tr>
							<tr>
							    <td class="laber"></td> 	
							    <td class="edit">
								    <button id="submit_btn" onclick="save();">添加</button> <span id="save_msg" style="color:#3CADED"></span>
							    </td>
							    <td class="info"></td>  
							</tr>
						</tbody> 
