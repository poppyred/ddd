	...
	<div id="sideMenu" class="side">
		...
		<div class="bd">
			<ul>
				...
				<li><a style="color:#3CADED; text-decoration:underline;" href="__APP__/Runmgr/addView">添加默认路线</a></li>
			</ul>
		</div>
		<div class="hd">
			<h3>用户自定义路线</h3>
					...
					<table class="ui-table" cellpadding="0" cellspacing="0" width="100%" id="mytab" style="margin-left:20px;">	
						<tbody id="myData">
							<tr class="data">
							    ...
							    <td class="edit"><input class="ui-ipt-txt" type="text" id="txt_name" value="<?php echo ($view["name"]); ?>" placeholder="路线名称"> *</td>
							    <td class="info">例如：广东电信</td>
							</tr>
							<tr class="data">
							    <td class="laber">路线级别</td>
							    <td class="edit"><input class="ui-ipt-txt" type="text" id="txt_level" value="<?php echo ($view["level"]); ?>" placeholder="路线级别"> *</td>
							    <td class="info">说明：＂路线级别＂决定了用户需要说明套餐才能使用该路线</td>
							</tr>
							<tr class="data">
							    <td class="laber">路线掩码</td>
							    <td class="edit"><textarea class="ui-ipt-txt" id="txt_mask" style="height: 111px; width: 239px;"><?php echo ($view["mask"]); ?></textarea></td>
