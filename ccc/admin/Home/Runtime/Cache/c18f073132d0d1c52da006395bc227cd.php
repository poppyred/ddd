...
<div class="content"><!-- 内容 -->
	...
	<div id="sideMenu" class="side">
		...
		<div class="bd">
			<ul>
				...
				<li><a style="color:#3CADED; text-decoration:underline;" href="__APP__/Runmgr/addRoute">添加用户自定义路线</a></li>
			</ul>
		</div>
		<div class="hd">
			<h3>NS服务地址</h3>
	...
	<div class="mainContent">
		...
		<div class="slideTxtBox">
			<div class="hd">
				<h2 style="float:left;">添加自定义路线</h2>
			</div>
			<div class="bd">
				<ul>
					<table class="ui-table" cellpadding="0" cellspacing="0" width="100%" id="mytab" style="margin-left:20px;">	
						<tbody id="myData">
							...
							<tr class="data">
							    <td class="laber">路线所属域名</td>
							    <td class="edit"><input class="ui-ipt-txt" type="text" id="txt_zone" placeholder="路线所属域名"> *</td>
							    <td class="info">说明：＂自定义路线＂是和域名绑定的</td>
							</tr>
							<tr class="data">
...
<script type="text/javascript">
	function save(){
		...
		if(!zone){
			$("#save_msg").html("请输入路线所属域名！");
			$("#txt_zone").focus();
			return false;
		}
		$.ajax({
			url: '__APP__/System/addRoute',
			type: "post",
			data:{'name':name, 'zone':zone, 'mask':mask},
