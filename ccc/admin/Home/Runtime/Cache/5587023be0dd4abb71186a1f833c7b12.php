...
<div class="content"><!-- 内容 -->
	...
	<div id="sideMenu" class="side">
		...
		<div class="bd">
			<ul>
				<li><a style="color:#3CADED; text-decoration:underline;" href="__APP__/Clientmgr/">个人客户管理</a></li>
				<li><a href="__APP__/Clientmgr/vip">企业客户管理</a></li>
			</ul>
		</div>
		<div class="hd">
			<h3>其他功能</h3>
					...
					<table class="ui-table" cellpadding="0" cellspacing="0" width="100%" id="mytab">
						...
						<tbody id="myData">
							<?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s_vo): $mod = ($i % 2 );++$i;?><tr class="data"> 	 	
								...
								<td class="val" style="text-align:left;"><?php echo ($s_vo["mail"]); ?></td>
