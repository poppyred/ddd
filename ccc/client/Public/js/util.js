...
function checkEmail(){
	...
	$.ajax({
		...
		success:function(data){
			if(data.info=='error'){
				showInfo('['+val+']  账户已存在，<a href="__APP__/Index/login">登陆</a> | 忘记密码？');
				return false;
			}
		},
		error:function(data){
