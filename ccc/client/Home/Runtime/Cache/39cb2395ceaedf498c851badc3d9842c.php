	...
	var stopPropagation = function(e) {
		...
		<div class="head-info">
			<div class="head-path">
				...
				<strong class="current">告警通知</strong>
			</div>
		</div> 
		<div class="J_singleTop">
			<p class="domain-title">
				...
				<span class="tab "><a href="__APP__/Index/alarm">告警通知</a></span>
			...
			<table class="ui-table" cellpadding="0" cellspacing="0" width="100%" id="mytab" style="font-size:14px;">
				...
				<tbody id="myData">
					<tr class="data" style="height:55px;">
					    <td class="laber" style="text-align:center;width:150px;">微信提醒</td>
					    <td class="edit">您开启了0项提醒</td>
					    <td class="info"><a href="javascript:void(0);" onClick="updateDesc()">修改</a></td>
					</tr>
					<tr class="data" style="height:55px;">
					    <td class="laber" style="text-align:center;width:150px;">短信提醒</td> 	
					    <td class="edit" style="width:520px;">您开启了0项提醒</td>
					    <td class="info"><a href="javascript:void(0);" onClick="updateDesc()">修改</a></td>
					</tr>
					<tr class="data" style="height:55px;">
					    <td class="laber" style="text-align:center;width:150px;">邮件提醒</td> 	
					    <td class="edit" style="width:520px;">您开启了0项提醒</td>
					    <td class="info"><a href="javascript:void(0);" onClick="updateDesc()">修改</a></td>
					</tr>
